...
This is an alpha version of OpenFL-JS, designed to use JavaScript, TypeScript or Haxe. It does not require the standard OpenFL command-line tools, and is designed to integrate more fully in a standard web development environment.
